        ...
        <>
          ...
          <section className="features-section">
            ...
            <div className="features-grid">
              ...
              <div className="feature-card">
                ...
                <h3>API Endpoints</h3>
                <p>Deploy your models with one click and integrate predictions into any application with our secure, scalable REST APIs.</p>
              </div>
            </div>
          </section>
          ...
          <section className="cta-section">
            <div className="cta-content">
              ...
              <button onClick={toggleNewProject} className="btn btn-primary btn-large">Start Building For Free</button>
            </div>
          </section>
        </>
      )}
